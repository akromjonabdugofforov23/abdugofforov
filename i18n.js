...
(function () {
    const translations = {
        uz: {
            ...
            "skills.title": "🛠️ Texnologiyalar & Ko'nikmalar",
            "skills.subtitle": "Men ishlatadigan zamonaviy vositalar va bilim sohalari",
            "form.artist": "Ijrochi",
            ...
            "fc.matching": "Matching Pairs (Moslashtirish)",
            "fc.matching_sub": "Nemischa so'z va tarjima juftlash o'yini",
            "fc.speedquiz": "Speed Quiz (Time-Attack)",
            "fc.speedquiz_sub": "60 soniyalik tezkor bilim poygasi",
            "deck.de_uz": "🇩🇪→🇺🇿 So'zlar",
            "deck.uz_de": "🇺🇿→🇩🇪 So'zlar",
            "deck.a1_verbs": "⚡ Kuchli fe'llar",
            "deck.a2_daily": "☕ Kundalik hayot",
            "deck.b1_connectors": "🔗 B1 Bog'lovchilar",
            "deck.rektion_verben": "🎯 Predlogli fe'llar",
            ...
            "de.mode.matching": "Matching Pairs",
            "de.mode.matching_sub": "Moslashtirish o'yini",
            "de.mode.speedquiz": "Speed Quiz",
            "de.mode.speedquiz_sub": "Tezkor poyga",
        ...
        ru: {
            ...
            "skills.title": "🛠️ Технологии и Навыки",
            "skills.subtitle": "Современные инструменты и сферы знаний, которые я использую",
            ...
            "fc.matching": "Matching Pairs (Пары)",
            "fc.matching_sub": "Мини-игра подбора слов и перевода",
            "fc.speedquiz": "Speed Quiz (Гонка)",
            "fc.speedquiz_sub": "60-секундная викторина на время",
            "deck.de_uz": "🇩🇪→🇺🇿 Слова",
            "deck.uz_de": "🇺🇿→🇩🇪 Слова",
            "deck.a1_verbs": "⚡ Сильные глаголы",
            "deck.a2_daily": "☕ Повседневная жизнь",
            "deck.b1_connectors": "🔗 B1 Союзы",
            "deck.rektion_verben": "🎯 Управление глаголов",
            ...
            "de.mode.matching": "Matching Pairs",
            "de.mode.matching_sub": "Игра подбора пар",
            "de.mode.speedquiz": "Speed Quiz",
            "de.mode.speedquiz_sub": "Гонка на время",
        ...
        de: {
            ...
            "skills.title": "🛠️ Technologien & Fähigkeiten",
            "skills.subtitle": "Moderne Tools und Wissensbereiche, die ich nutze",
            ...
            "fc.matching": "Matching Pairs (Paare)",
            "fc.matching_sub": "Wort- und Übersetzung-Match-Spiel",
            "fc.speedquiz": "Speed Quiz (Time-Attack)",
            "fc.speedquiz_sub": "60-Sekunden-Sprint-Quiz",
            "deck.de_uz": "🇩🇪→🇺🇿 Wörter",
            "deck.uz_de": "🇺🇿→🇩🇪 Wörter",
            "deck.a1_verbs": "⚡ Starke Verben",
            "deck.a2_daily": "☕ Alltag & Reisen",
            "deck.b1_connectors": "🔗 B1 Konnektoren",
            "deck.rektion_verben": "🎯 Rektion der Verben",
            ...
            "de.mode.matching": "Matching Pairs",
            "de.mode.matching_sub": "Paare finden",
            "de.mode.speedquiz": "Speed Quiz",
            "de.mode.speedquiz_sub": "60s Sprint",
        ...
        en: {
            ...
            "skills.subtitle": "Modern tools and areas of knowledge I use",
            "form.artist": "Artist",
            "form.musicLink": "Link (YouTube / Telegram)",
            ...
            "fc.matching": "Matching Pairs",
            "fc.matching_sub": "German word & translation matching game",
            "fc.speedquiz": "Speed Quiz (Time-Attack)",
            "fc.speedquiz_sub": "60s rapid-fire knowledge challenge",
            "deck.de_uz": "🇩🇪→🇺🇿 Words",
            "deck.uz_de": "🇺🇿→🇩🇪 Words",
            "deck.a1_verbs": "⚡ Strong Verbs",
            "deck.a2_daily": "☕ Daily Life & Travel",
            "deck.b1_connectors": "🔗 B1 Connectors",
            "deck.rektion_verben": "🎯 Prepositional Verbs",
            ...
            "de.mode.matching": "Matching Pairs",
            "de.mode.matching_sub": "Pairs Matching Mini-Game",
            "de.mode.speedquiz": "Speed Quiz",
            "de.mode.speedquiz_sub": "Time-Attack Sprint",
